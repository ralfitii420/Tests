...
fareinheiti = celsijs * 9 / 5 + 32
print(f"Temperatūra {celsijs} grādi pēc Celsija skalas ir {fareinheiti} grādi pēc Fareinheita skalas ")

platums=float(input("platums:"))
garums=float(input("garums: "))
augstums=float(input("augstums: "))
print(f"tilpums ir {platums*augstums*garums}.")
